...
export default {
  install: (Vue) => {
    Vue.config.globalProperties.$deviceDrag = reactive(stateDataProxy);

    Vue.directive(`device-drag`, {
      mounted(el, binding) {
        console.log("device-drag");
        ...
        const dragStart = (event) => {
          ...
          const delayTimeout = setTimeout(() => {
            ...
            stateDataProxy.isDragging = `${setDataTip}true`;
          }, delayTime);
          let cancel = false;
          const cancelDrag = () => {
            cancel = true;
          ...
          const dragEnd = () => {
            ...
            eleCopy.remove();
            stateDataProxy.isDragging = `${setDataTip}false`;
